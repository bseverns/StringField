...
- **Handout beats:** Four printable bullets you can read aloud. They tell you to flip on the logger _after_ consent, mirror packets to OSC, and run the README preset browser steps so students hear the scale change.
